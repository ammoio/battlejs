...
var balancedParens = new Models.Challenge({
  ...
  outputs: ['[](){}', '[(]{)}', ' var hubble = function() { telescopes.awesome();', ' var wow  = { yo: thisIsAwesome() }'],
...
var evenOccurence = new Models.Challenge({
  ...
  outputs: ['[1,2,3,4,5,6,7,8,9,1]', '[1,1,2,3,4,3,2,1]', '[5,5,5,4,4,5]', '[]', '[1,1,3,4,1]'],
...
var sumArray = new Models.Challenge({
  ...
  outputs: ['[1, 2, 3]', '[1, -3, 2, 3]', '[5, 2, -3, 2]', '[-5, -1, -3]'],
